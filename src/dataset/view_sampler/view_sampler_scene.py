...
class ViewSamplerScene:
    cfg: ViewSamplerSceneCfg
    ...
    def __init__(self,
        ...
        self.cfg = cfg
        self.stage = stage
        self.is_overfitting = cfg.is_overfitting
        self.cameras_are_circular = cfg.cameras_are_circular
        self.step_tracker = cfg.step_tracker
